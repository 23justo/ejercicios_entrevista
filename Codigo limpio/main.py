...
def ordenar_lista(lista: list) -> list:
    ...
    lista_por_partes['menores'] = [menor_iter for menor_iter in lista if menor_iter < random_pivot]
    lista_por_partes['iguales'] = [igual_iter for igual_iter in lista if igual_iter == random_pivot]
    lista_por_partes['mayores'] = [mayor_iter for mayor_iter in lista if mayor_iter > random_pivot]
